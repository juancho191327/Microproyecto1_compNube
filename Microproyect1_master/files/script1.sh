...
cd Microproyecto1_compNube/Microproyect1_master/web2
npm install consul
npm install express
cd ../..
...
#!/bin/bash
# -*- ENCODING: UTF-8 -*-
consul agent -ui -server -data-dir=. -node=agent-two -bind=192.168.100.6 -client=0.0.0.0 -enable-script-checks=true -config-dir=/etc/consul.d -retry-join "192.168.100.5"
TEST
